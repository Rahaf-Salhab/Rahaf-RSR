...
import {
  ...
  Grade, Archive, Person, Logout, Close, RateReview, Schedule, Folder,
...
const sidebarConfig = {
  ...
  supervisor: [
    ...
    { label: "My Projects", icon: <Folder />, path: "/supervisor/projects" },
    { label: "Evaluation Forms", icon: <RateReview />, path: "/supervisor/evaluation-forms" },
    { label: "Thesis Management", icon: <MenuBook />, path: "/supervisor/thesis-management" },

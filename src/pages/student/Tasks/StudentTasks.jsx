...
export default function StudentTasks() {
  ...
  const fetchGroupTasks = async () => {
    try {
      ...
      // بنجيب id الطالب من اللوكال ستوريج بعد تسجيل الدخول
      ...
      // 1) نجيب الجروب اللي الطالب موجود فيه
  ...
  // بنحسب عدد التاسكات في كل حالة عشان نعرضها في الستاتس كاردز فوق
      ...
      {filteredTasks.length === 0 ? (
        ...
        <div className={styles.tasksList}>
          {filteredTasks.map((task) => {
            ...
            const deadline = task.deadLine || task.deadline || task.dueDate;
            const daysText = getDaysText(deadline, status);

            return (
              <div className={styles.taskCard} key={task.taskId || task.id}>
                  ...
                  <div className={styles.cardLeft}>
                    ...
                    <div className={styles.taskMain}>
                      <div className={styles.titleRow}>
                        ...
                        <span
                          className={`${styles.badge} ${getStatusBadgeClass(status)}`}
                        >
                          {status}
                        </span>
                      </div>
